...
model.save_pretrained("/home/marino/tesi/models/all-MiniLM-L6-v2_train1")  # Local saving
model.tokenizer.save_pretrained("/home/marino/tesi/models/all-MiniLM-L6-v2_train1")